...
### Primary
- **Coral Sinal** (`#c8341a` claro (5,3:1 sobre branco; o `#ff5a3c` original dava 3,1:1 e foi trocado após o critique da v2) / `#ff8266` escuro): logo (ponto final), links ativos/
...
- **Error:** borda no tom "Erro" (`{colors.error}`, `#c4282e`, agora documentado como
